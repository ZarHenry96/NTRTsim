...
#ifndef APP_QUAD_CONTROL_SPIRAL2_H
#define APP_QUAD_CONTROL_SPIRAL2_H

/**
 * @file AppQuadCoupling.cpp
...
//robot
#include "dev/dhustigschultz/BigPuppy_SymmetricSpiral2/BigPuppySymmetricSpiral2.h"

// controller 
#include "dev/bgigous/MG_FirstAttempt/JSONQuadFeedbackControl.h"
...
class AppQuadCoupling
{
public:
    AppQuadCoupling(int argc, char** argv);
...
#endif  // APP_QUAD_CONTROL_SPIRAL2_H
