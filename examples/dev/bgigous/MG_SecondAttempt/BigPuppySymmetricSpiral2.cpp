 ...
 */
 ...
 /**
 * @file BigPuppySymmetricSpiral2.cpp
...
BigPuppySymmetricSpiral2::BigPuppySymmetricSpiral2(int segments, int hips, int legs, int feet) :
...
BigPuppySymmetricSpiral2::~BigPuppySymmetricSpiral2()
{
}

void BigPuppySymmetricSpiral2::addNodesFoot(tgStructure& s, double r1, double r2){
    s.addNode(r2,0,r2);//0 
    s.addNode(r2,0,-r2);//1
    s.addNode(-r2,0,-r2);//2 
    s.addNode(-r2,0,r2);//3 
...
void BigPuppySymmetricSpiral2::addRodsFoot(tgStructure& s){
    s.addPair(0,6,"rod");
    s.addPair(1,7,"rod");
    s.addPair(2,4,"rod");
    s.addPair(3,5,"rod");
...
void BigPuppySymmetricSpiral2::addNodesLeg(tgStructure& s, double r){ 
	...
	/*
	s.addNode(0,-r/1.8,-r/4); //6
    s.addNode(0,-r/1.8,r/4); //7
    s.addNode(r/4,-r/1.8,0); //8
    s.addNode(-r/4,-r/1.8,0); //9 
	*/
}

void BigPuppySymmetricSpiral2::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void BigPuppySymmetricSpiral2::addNodesHip(tgStructure& s, double r){
...
void BigPuppySymmetricSpiral2::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void BigPuppySymmetricSpiral2::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void BigPuppySymmetricSpiral2::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void BigPuppySymmetricSpiral2::addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void BigPuppySymmetricSpiral2::addMuscles(tgStructure& puppy){ 
    ...
    puppy.addPair(n11[4], n7[3], tgString("right_front_leg outer bicep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n11[4], n7[2], tgString("right_front_leg inner bicep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n11[4], n1[4], tgString("right_front_leg front abdomen connection muscle seg", 10) + tgString(" seg", 1));
    puppy.addPair(n11[3], n1[1],tgString("right_front_leg front abdomen connection muscle3 seg", 11) + tgString(" seg", 5)); 
    puppy.addPair(n11[2], n1[4],tgString("right_front_leg abdomen connection muscle3 seg", 11) + tgString(" seg", 5)); 

    puppy.addPair(n11[3], n7[3], tgString("right_front_leg outer tricep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n11[3], n7[2], tgString("right_front_leg inner tricep muscle seg", 10) + tgString(" seg", 6));

    puppy.addPair(n11[2], n7[3], tgString("right_front_leg outer front tricep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n11[2], n7[2], tgString("right_front_leg inner front tricep muscle seg", 10) + tgString(" seg", 6));

    //Adding muscle to pull up on right front leg:
    puppy.addPair(n11[4], n7[1], tgString("right_front_leg mid bicep muscle3 seg", 10) + tgString(" seg", 6));

    //puppy.addPair(n11[5], n7[2], tgString("right_front_leg inner extra muscle seg", 11) + tgString(" seg", 7));
    //puppy.addPair(n11[5], n7[3], tgString("right_front_leg inner extra muscle seg", 11) + tgString(" seg", 7));
    
    //Left front leg/shoulder
    puppy.addPair(n13[4], n9[3], tgString("left_front_leg outer bicep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n13[4], n9[2], tgString("left_front_leg inner bicep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n13[4], n1[3], tgString("left_front_leg front abdomen connection muscle seg", 12) + tgString(" seg", 1)); //Was n1[2]
    puppy.addPair(n13[3], n1[2], tgString("left_front_leg front abdomen connection muscle3 seg", 13) + tgString(" seg", 5)); 
    puppy.addPair(n13[2], n1[3], tgString("left_front_leg abdomen connection muscle3 seg", 13) + tgString(" seg", 5)); 

    puppy.addPair(n13[3], n9[3], tgString("left_front_leg outer tricep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n13[3], n9[2], tgString("left_front_leg inner tricep muscle seg", 12) + tgString(" seg", 8));

    puppy.addPair(n13[2], n9[3], tgString("left_front_leg outer front tricep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n13[2], n9[2], tgString("left_front_leg inner front tricep muscle seg", 12) + tgString(" seg", 8));

    //Adding muscle to pull up on left front leg:
    puppy.addPair(n13[4], n9[1], tgString("left_front_leg mid bicep muscle3 seg", 12) + tgString(" seg", 8));
	
	//puppy.addPair(n13[5], n9[2], tgString("left_front_leg extra muscle seg", 13) + tgString(" seg", 9));
	//puppy.addPair(n13[5], n9[3], tgString("left_front_leg extra muscle seg", 13) + tgString(" seg", 9));

    //Right rear leg/hip
    puppy.addPair(n12[4], n8[3], tgString("right_hind_leg outer thigh muscle seg", 11) + tgString(" seg", 7)); 
    puppy.addPair(n12[4], n8[2], tgString("right_hind_leg inner thigh muscle seg", 11) + tgString(" seg", 7));

    puppy.addPair(n12[4], n3[1],tgString("right_hind_leg rear abdomen connection muscle seg", 11) + tgString(" seg", 3)); 
    puppy.addPair(n12[3], n5[1],tgString("right_hind_leg rear abdomen connection muscle3 seg", 11) + tgString(" seg", 5)); 
    puppy.addPair(n12[2], n5[4],tgString("right_hind_leg rear abdomen connection muscle3 seg", 11) + tgString(" seg", 5)); 

    puppy.addPair(n12[3], n8[3], tgString("right_hind_leg outer calf muscle seg", 11) + tgString(" seg", 7));
    puppy.addPair(n12[3], n8[2], tgString("right_hind_leg inner calf muscle seg", 11) + tgString(" seg", 7));

    puppy.addPair(n12[2], n8[3], tgString("right_hind_leg outer front calf muscle seg", 11) + tgString(" seg", 7));
    puppy.addPair(n12[2], n8[2], tgString("right_hind_leg inner front calf muscle seg", 11) + tgString(" seg", 7));

    //Adding muscle to pull rear right leg up:
    puppy.addPair(n12[4], n8[1], tgString("right_hind_leg central thigh muscle3 seg", 11) + tgString(" seg", 7));

    //puppy.addPair(n12[5], n8[2], tgString("right_hind_leg extra muscle seg", 12) + tgString(" seg", 8));
    //puppy.addPair(n12[5], n8[3], tgString("right_hind_leg extra muscle seg", 12) + tgString(" seg", 8));


    //Left rear leg/hip
    puppy.addPair(n14[4], n10[3], tgString("left_hind_leg outer thigh muscle seg", 13) + tgString(" seg", 9));
    puppy.addPair(n14[4], n10[2], tgString("left_hind_leg inner thigh muscle seg", 13) + tgString(" seg", 9)); 

    puppy.addPair(n14[4], n3[2], tgString("left_hind_leg rear abdomen connection muscle seg", 13) + tgString(" seg", 3)); 
    puppy.addPair(n14[3], n5[2], tgString("left_hind_leg rear abdomen connection muscle3 seg", 13) + tgString(" seg", 5)); 
    puppy.addPair(n14[2], n5[3], tgString("left_hind_leg rear abdomen connection muscle3 seg", 13) + tgString(" seg", 5)); 

    puppy.addPair(n14[3], n10[3], tgString("left_hind_leg outer calf muscle seg", 13) + tgString(" seg", 9));
    puppy.addPair(n14[3], n10[2], tgString("left_hind_leg inner calf muscle seg", 13) + tgString(" seg", 9));

    puppy.addPair(n14[2], n10[3], tgString("left_hind_leg outer front calf muscle seg", 13) + tgString(" seg", 9));
    puppy.addPair(n14[2], n10[2], tgString("left_hind_leg inner front calf muscle seg", 13) + tgString(" seg", 9));

    //Adding muscle to pull rear left leg up:
    puppy.addPair(n14[4], n10[1], tgString("left_hind_leg central thigh muscle3 seg", 13) + tgString(" seg", 9));

	// Right front leg to right back leg
    //puppy.addPair(n11[0], n12[0], tgString("right leg_to leg muscleAct seg", 11) + tgString(" seg", 7));
	// Left front leg to right back leg
    //puppy.addPair(n13[0], n14[0], tgString("left leg_to leg muscleAct seg", 11) + tgString(" seg", 7));

	puppy.addPair(n4[2], n11[0], tgString("right front leg_to spine muscleAct seg", 11) + tgString(" seg", 7));
	puppy.addPair(n2[3], n12[0], tgString("right hind leg_to spine muscleAct seg", 11) + tgString(" seg", 7));
	puppy.addPair(n4[2], n13[0], tgString("left front leg_to spine muscleAct seg", 11) + tgString(" seg", 7));
	puppy.addPair(n2[3], n14[0], tgString("left hind leg_to spine muscleAct seg", 11) + tgString(" seg", 7));
	puppy.addPair(n6[3], n11[0], tgString("right front leg_to spine middle muscleAct seg", 11) + tgString(" seg", 7));
	puppy.addPair(n0[2], n12[0], tgString("right hind leg_to spine middle muscleAct seg", 11) + tgString(" seg", 7));
...
void BigPuppySymmetricSpiral2::setup(tgWorld& world)
{
    ...
    const double stiffnessPassive = 2000.0;
	const double stiffnessPassive2 = 10000.0;
    const double damping = .01*stiffness;
    const double pretension = 0.0; 
    const bool   history = true;
    const double maxTens = 10000000.0; // 7000
    const double maxSpeed = 1000000.0; // 12
	...
	tgKinematicActuator::Config motorConfigFeet(stiffnessPassive, damping, passivePretension,
                                            mRad, motorFriction, motorInertia, backDrivable,
                                            history, maxTens, maxSpeed); 
	tgKinematicActuator::Config motorConfigLegs(stiffnessPassive2, damping, passivePretension4,
                                            mRad, motorFriction, motorInertia, backDrivable,
                                            history, maxTens, maxSpeed);
    #endif
    ...
    #ifdef PASSIVE_STRUCTURE
        tgSpringCableActuator::Config muscleConfig(2000, 20, passivePretension, history);
	...
	tgSpringCableActuator::Config muscleConfigLegs(stiffness, damping, passivePretension); // stiffnessPassive, passivePretention4
	...
	tgSpringCableActuator::Config muscleConfigFeet(stiffnessPassive, damping, passivePretension, history); 
	tgSpringCableActuator::Config muscleConfigLegs(stiffnessPassive2, damping, passivePretension4, history);
    #endif
    ...
    addSegments(puppy,vertebra,hip,leg,rod_space); 

    puppy.move(btVector3(0.0,-yOffset_foot+2,0.0));
...
void BigPuppySymmetricSpiral2::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void BigPuppySymmetricSpiral2::teardown()
{
