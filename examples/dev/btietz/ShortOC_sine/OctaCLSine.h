...
#ifndef OCTACL_SINE_H
#define OCTACL_SINE_H

/**
 * @file OctaCLSine.h
 * @brief Controller for FlemonsSpineLearningModelCL
 ...
 */
class OctaCLSine : public BaseSpineCPGControl
{
public:

    OctaCLSine(BaseSpineCPGControl::Config config,	
							std::string args,
