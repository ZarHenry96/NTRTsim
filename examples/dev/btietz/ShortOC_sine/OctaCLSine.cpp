...
/**
 * @file OctaCLSine.cpp
 * @brief Controller for BaseSpineLearningModel
 ...
 */
OctaCLSine::OctaCLSine(BaseSpineCPGControl::Config config,
												std::string args,
...
void OctaCLSine::onSetup(BaseSpineModelLearning& subject)
{
...
array_2D OctaCLSine::scalePhaseActions  
...
array_2D OctaCLSine::scaleNodeActions  
                            (vector< vector <double> > actions)
{
