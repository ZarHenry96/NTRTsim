...
FlemonsSpineModelContact::FlemonsSpineModelContact(int segments) : 
    BaseSpineModelLearning(segments) 
{
}

FlemonsSpineModelContact::~FlemonsSpineModelContact()
{
}

void FlemonsSpineModelContact::setup(tgWorld& world)
{
...
void FlemonsSpineModelContact::teardown()
{
...
void FlemonsSpineModelContact::step(double dt)
{
