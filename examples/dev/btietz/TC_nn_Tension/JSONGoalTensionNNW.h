...
#ifndef JSON_GOAL_TENSION_NNW_H
#define JSON_GOAL_TENSION_NNW_H

/**
 * @file JSONGoalTensionNNW.h
 ...
 */
class JSONGoalTensionNNW : public JSONGoalControl
{
public:

    JSONGoalTensionNNW(JSONGoalControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONGoalTensionNNW();
