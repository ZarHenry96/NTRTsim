...
// This application
#include "apps/learningSpines/OctahedralComplex/FlemonsSpineModelLearningCL.h"
// This library
...
int main(int argc, char** argv)
{
    ...
    JSONCPGControl::Config control_config(segmentSpan, numMuscles, numMuscles, numParams, segNumber, controlTime,
												lowAmplitude, highAmplitude, lowPhase, highPhase,
												tension, kPosition, kVelocity);
    JSONCPGControl* const myControl =
      new JSONCPGControl(control_config, suffix, "learningSpines/OctahedralComplex/");
    ...
    while (i < 20000)
    {
        ...
        simulation.reset();
        std::cout << "Dist:" << myControl->getScore() << std::endl;
        i++;
    }
