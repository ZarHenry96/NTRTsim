...
void AppGoalTension::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppGoalTension::getHillyConfig()
{
...
const tgBoxGround::Config AppGoalTension::getBoxConfig()
{
...
tgModel* AppGoalTension::getBlocks()
{
...
tgWorld* AppGoalTension::createWorld()
{
...
tgSimViewGraphics *AppGoalTension::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppGoalTension::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppGoalTension::run()
{
    if (!bSetup)
    {
        setup();
...
void AppGoalTension::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppGoalTension" << std::endl;
    AppGoalTension app (argc, argv);
