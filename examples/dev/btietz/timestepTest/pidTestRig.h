...
#ifndef PID_TEST_RIG_H
#define PID_TEST_RIG_H
 ...
 * in tgcreator.
 */
class pidTestRig : public tgSubject<pidTestRig>, public tgModel
{
public: 
...
private:
     ...
     * a sine wave to the spring-cable actuators
     */
    std::vector<tgSCASineControl*> m_tgSCASineControllers;
