...
{
    std::cout << "AppConnectorTest" << std::endl;

    // First create the world
    tgWorld world;  
    // Second create the view
    tgSimViewGraphics view(world);
    // Third create the simulation
    tgSimulation simulation(view);
    // Fourth create the models with their controllers and add the models to the
    // simulation
    ConnectorTestModel* const myModel =
      new ConnectorTestModel("ConnectorTestModel");
    //ConnectorTestController* muscleControl = new ConnectorTestController();
