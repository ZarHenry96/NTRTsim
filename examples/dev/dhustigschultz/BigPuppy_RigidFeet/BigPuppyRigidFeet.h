...
#ifndef BIGPUPPY_RIGID_FEET_H
#define BIGPUPPY_RIGID_FEET_H

/**
 * @file BigPuppyRigidFeet.h
...
class BigPuppyRigidFeet: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigPuppyRigidFeet(int segments, int hips, int legs, int feet);

    virtual ~BigPuppyRigidFeet();
...
private:
    ...
    */
    void addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, 
