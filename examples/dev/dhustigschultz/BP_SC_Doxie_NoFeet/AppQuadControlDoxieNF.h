...
#ifndef APP_QUAD_CONTROL_DOXIE_NF_H
#define APP_QUAD_CONTROL_DOXIE_NF_H

/**
 * @file AppQuadControlDoxieNF.h
...
//robot
#include "dev/dhustigschultz/BigDoxieNoFeet/BigDoxieNoFeet.h"
...
class AppQuadControlDoxieNF
{
public:
    AppQuadControlDoxieNF(int argc, char** argv);
