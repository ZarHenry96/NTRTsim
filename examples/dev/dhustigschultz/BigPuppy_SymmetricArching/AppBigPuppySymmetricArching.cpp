...
/**
 * @file AppBigPuppySymmetricArching.cpp
...
{
    std::cout << "AppBigPuppySymmetricArching" << std::endl;
    ...
    BigPuppySymmetricArching* const myModel = new BigPuppySymmetricArching(segments, hips, legs, feet);
