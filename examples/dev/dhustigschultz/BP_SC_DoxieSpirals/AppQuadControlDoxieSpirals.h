...
#ifndef APP_QUAD_CONTROL_DOXIE_SPIRALS_H
#define APP_QUAD_CONTROL_DOXIE_SPIRALS_H

/**
 * @file AppQuadControlDoxieSpirals.h
 * @brief Contains the definition function main() for the Multiple terrains app, used here for control of a quadruped with more spine segments.
 * @author Brian Mirletz, Alexander Xydes, Dawn Hustig-Schultz
 * $Id$
 */

//robot
#include "dev/dhustigschultz/BigDoxieSpirals/BigDoxieSpirals.h"
...
class AppQuadControlDoxieSpirals
{
public:
    AppQuadControlDoxieSpirals(int argc, char** argv);
...
#endif  // APP_QUAD_CONTROL_DOXIE_H
