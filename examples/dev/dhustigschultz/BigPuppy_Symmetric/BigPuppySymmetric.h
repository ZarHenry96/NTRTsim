...
#ifndef BIGPUPPY_SYMMETRIC_H
#define BIGPUPPY_SYMMETRIC_H
...
class BigPuppySymmetric: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public:

    BigPuppySymmetric(int segments, int hips, int legs, int feet);

    virtual ~BigPuppySymmetric();
