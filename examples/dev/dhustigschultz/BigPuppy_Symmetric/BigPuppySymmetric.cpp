...
BigPuppySymmetric::~BigPuppySymmetric()
{
}

void BigPuppySymmetric::addNodesFoot(tgStructure& s, double r1, double r2){
    s.addNode(r2,0,r2);//0 
    s.addNode(r2,0,-r2);//1
    s.addNode(-r2,0,-r2);//2 
    s.addNode(-r2,0,r2);//3 
...
void BigPuppySymmetric::addRodsFoot(tgStructure& s){
    s.addPair(0,6,"rod");
    s.addPair(1,7,"rod");
    s.addPair(2,4,"rod");
    s.addPair(3,5,"rod");
...
void BigPuppySymmetric::addNodesLeg(tgStructure& s, double r){ 
...
void BigPuppySymmetric::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void BigPuppySymmetric::addNodesHip(tgStructure& s, double r){
...
void BigPuppySymmetric::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void BigPuppySymmetric::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void BigPuppySymmetric::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void BigPuppySymmetric::addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, tgStructure& foot, 
                 double r){ 
...
void BigPuppySymmetric::addMuscles(tgStructure& puppy){ 
...
void BigPuppySymmetric::setup(tgWorld& world)
{
...
void BigPuppySymmetric::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void BigPuppySymmetric::teardown()
{
