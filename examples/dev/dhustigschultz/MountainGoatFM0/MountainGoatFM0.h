...
#ifndef MOUNTAIN_GOAT_FM0_H
#define MOUNTAIN_GOAT_FM0_H

/**
 * @file MountainGoatFM0.h
 * @brief Implementing MountainGoat, but as a subclass of Brian's BaseSpineModelLearning module.
 * Seeing what will happen when the number of actuators is reduced, and their placement has changed. 
...
class MountainGoatFM0: public BaseQuadModelLearning 
{
public: 

    MountainGoatFM0(int segments, int hips, int legs);

    virtual ~MountainGoatFM0();
