...
#ifndef BIGPUPPY_NO_FEET_H
#define BIGPUPPY_NO_FEET_H

/**
 * @file BigPuppyNoFeet.h
...
class BigPuppyNoFeet: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigPuppyNoFeet(int segments, int hips, int legs, int feet);

    virtual ~BigPuppyNoFeet();
