...
#ifndef APP_MIXED_LEARNING
#define APP_MIXED_LEARNING
...
// controller 
#include "dev/dhustigschultz/TC_MixedLearning/JSONMixedLearningControl.h"
...
class AppMixedLearning
{
public:
    AppMixedLearning(int argc, char** argv);
