...
#include "RibModelMixedContact.h"
...
namespace
{
	...
	if (i == 1)
        {
	    snake.addPair(n0[1], n1[1], tgString("starting outer front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[2], n1[2], tgString("starting outer right muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[3], tgString("starting outer back muscleAct seg", i-1) + tgString(" seg", i));

	    snake.addPair(n0[2], n1[1], tgString("starting inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[1], tgString("starting inner right muscleAct seg", i-1) + tgString(" seg", i));
	
	    snake.addPair(n0[2], r20[3], tgString("starting inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], r21[3], tgString("starting inner right muscleAct seg", i-1) + tgString(" seg", i));
	}
	else if (i == children.size() - 1)
	{
	    snake.addPair(n0[1], n1[1], tgString("ending outer front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[2], n1[2], tgString("ending outer right muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[3], tgString("ending outer back muscleAct seg", i-1) + tgString(" seg", i));

	    snake.addPair(n0[2], n1[1], tgString("ending inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[1], tgString("ending inner right muscleAct seg", i-1) + tgString(" seg", i));
	
	    snake.addPair(n0[2], r20[3], tgString("ending inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], r21[3], tgString("ending inner right muscleAct seg", i-1) + tgString(" seg", i));
	}
	else
	{
	    snake.addPair(n0[1], n1[1], tgString("middle outer front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[2], n1[2], tgString("middle outer right muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[3], tgString("middle outer back muscleAct seg", i-1) + tgString(" seg", i));

	    snake.addPair(n0[2], n1[1], tgString("middle inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], n1[1], tgString("middle inner right muscleAct seg", i-1) + tgString(" seg", i));
	
	    snake.addPair(n0[2], r20[3], tgString("middle inner front muscleAct seg", i-1) + tgString(" seg", i));
	    snake.addPair(n0[3], r21[3], tgString("middle inner right muscleAct seg", i-1) + tgString(" seg", i));
	}
...
RibModelMixedContact::RibModelMixedContact(int segments) :
    BaseSpineModelLearning(segments)
{
}

RibModelMixedContact::~RibModelMixedContact()
{
}
...
void RibModelMixedContact::teardown()
{
...
void RibModelMixedContact::step(double dt)
{
