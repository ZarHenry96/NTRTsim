...
#ifndef BIGDOXIE_NOFEET_H
#define BIGDOXIE_NOFEET_H

/**
 * @file BigDoxieNoFeet.h
...
class BigDoxieNoFeet: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigDoxieNoFeet(int segments, int hips, int legs, int feet);

    virtual ~BigDoxieNoFeet();
