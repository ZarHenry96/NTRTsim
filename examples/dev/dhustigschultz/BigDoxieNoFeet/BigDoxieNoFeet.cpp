...
BigDoxieNoFeet::BigDoxieNoFeet(int segments, int hips, int legs, int feet) :
...
void BigDoxieNoFeet::addRodsFoot(tgStructure& s){
    s.addPair(0,6,"rod");
    s.addPair(1,7,"rod");
    s.addPair(2,4,"rod");
    s.addPair(3,5,"rod");
...
void BigDoxieNoFeet::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}
...
void BigDoxieNoFeet::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void BigDoxieNoFeet::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
