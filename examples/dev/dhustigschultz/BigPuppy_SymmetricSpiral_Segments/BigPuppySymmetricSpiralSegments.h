...
#ifndef BIGPUPPY_SYMMETRIC_SPIRAL_SEGMENTS_H
#define BIGPUPPY_SYMMETRIC_SPIRAL_SEGMENTS_H

/**
 * @file BigPuppySymmetricSpiralSegments.h
...
class BigPuppySymmetricSpiralSegments: public BaseQuadModelLearning 
{
public: 

    BigPuppySymmetricSpiralSegments(int segments, int hips, int legs);

    virtual ~BigPuppySymmetricSpiralSegments();
