...
/**
 * @file AppBigPuppySymmetricSpiralSegments.cpp
...
{
    std::cout << "AppBigPuppySymmetricSpiralSegments" << std::endl;
    ...
    BigPuppySymmetricSpiralSegments* const myModel = new BigPuppySymmetricSpiralSegments(segments, hips, legs);
