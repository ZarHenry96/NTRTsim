...
/**
 * @file AppBigPuppySymmetricSpiralMetrics.cpp
...
{
    std::cout << "AppBigPuppySymmetricSpiralMetrics" << std::endl;
    ...
    BigPuppySymmetricSpiralMetrics* const myModel = new BigPuppySymmetricSpiralMetrics(segments, hips, legs);
