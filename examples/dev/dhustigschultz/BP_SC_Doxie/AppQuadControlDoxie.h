...
#ifndef APP_QUAD_CONTROL_DOXIE_H
#define APP_QUAD_CONTROL_DOXIE_H

/**
 * @file AppQuadControlDoxie.h
...
//robot
#include "dev/dhustigschultz/BigDoxie/BigDoxie.h"
...
class AppQuadControlDoxie
{
public:
    AppQuadControlDoxie(int argc, char** argv);
