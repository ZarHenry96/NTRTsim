...
#ifndef BIGPUPPY_SPINEONLY_H
#define BIGPUPPY_SPINEONLY_H

/**
 * @file BigPuppySymmetric.h
...
class BigPuppySpineOnly: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigPuppySpineOnly(int segments, int hips);

    virtual ~BigPuppySpineOnly();
