...
/**
 * @file MountainGoatAchilles.h
 * @brief Trying a longer achilles tendon muscle on the MountainGoat.
 * Trying to stiffen up the legs more, to prevent falling when actuated.
...
class MountainGoatAchilles: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchilles(int segments, int hips, int legs);

    virtual ~MountainGoatAchilles();
