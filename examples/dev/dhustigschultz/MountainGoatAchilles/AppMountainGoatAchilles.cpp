...
/**
 * @file AppMountainGoatAchilles.cpp
...
{
    std::cout << "AppMountainGoatAchilles" << std::endl;
    ...
    MountainGoatAchilles* const myModel = new MountainGoatAchilles(segments, hips, legs);
