...
//This application
#include "BigPuppySymmetricSpiral1.h"
...
BigPuppySymmetricSpiral1::BigPuppySymmetricSpiral1(int segments, int hips, int legs, int feet) :
...
BigPuppySymmetricSpiral1::~BigPuppySymmetricSpiral1()
{
}

void BigPuppySymmetricSpiral1::addNodesFoot(tgStructure& s, double r1, double r2){
    s.addNode(r2,0,r2);//0 
    s.addNode(r2,0,-r2);//1
    s.addNode(-r2,0,-r2);//2 
    s.addNode(-r2,0,r2);//3 
...
void BigPuppySymmetricSpiral1::addRodsFoot(tgStructure& s){
    s.addPair(0,6,"rod");
    s.addPair(1,7,"rod");
    s.addPair(2,4,"rod");
    s.addPair(3,5,"rod");
...
void BigPuppySymmetricSpiral1::addNodesLeg(tgStructure& s, double r){ 
...
void BigPuppySymmetricSpiral1::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void BigPuppySymmetricSpiral1::addNodesHip(tgStructure& s, double r){
...
void BigPuppySymmetricSpiral1::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void BigPuppySymmetricSpiral1::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void BigPuppySymmetricSpiral1::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void BigPuppySymmetricSpiral1::addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, tgStructure& foot, 
                 double r){ 
...
void BigPuppySymmetricSpiral1::addMuscles(tgStructure& puppy){ 
...
void BigPuppySymmetricSpiral1::setup(tgWorld& world)
{
...
void BigPuppySymmetricSpiral1::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void BigPuppySymmetricSpiral1::teardown()
{
