...
#ifndef BIGPUPPY_SYMMETRIC_SPIRAL1_H
#define BIGPUPPY_SYMMETRIC_SPIRAL1_H

/**
 * @file BigPuppySymmetricSpiral1.h
...
class BigPuppySymmetricSpiral1: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigPuppySymmetricSpiral1(int segments, int hips, int legs, int feet);

    virtual ~BigPuppySymmetricSpiral1();
