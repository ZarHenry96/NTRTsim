...
class BigDoxieSpirals: public BaseSpineModelLearning //public tgSubject<BigPuppy>, public tgModel
{
public: 

    BigDoxieSpirals(int segments, int hips, int legs, int feet);

    virtual ~BigDoxieSpirals();
