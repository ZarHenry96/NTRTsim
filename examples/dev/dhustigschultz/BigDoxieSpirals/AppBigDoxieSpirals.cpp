...
/**
 * @file AppBigDoxieSpirals.cpp
 * @brief Implementing the Flemons quadruped model. Now with more spine segments. 
...
{
    std::cout << "AppBigDoxieSpirals" << std::endl;
    ...
    BigDoxieSpirals* const myModel = new BigDoxieSpirals(segments, hips, legs, feet);
