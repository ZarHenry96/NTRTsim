...
#ifndef MOUNTAIN_GOAT_H
#define MOUNTAIN_GOAT_H
...
class MountainGoat: public BaseQuadModelLearning 
{
public: 

    MountainGoat(int segments, int hips, int legs);

    virtual ~MountainGoat();
