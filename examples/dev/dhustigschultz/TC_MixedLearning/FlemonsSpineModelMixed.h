...
#ifndef FLEMONS_SPINE_MODEL_MIXED_H
#define FLEMONS_SPINE_MODEL_MIXED_H

/**
 * @file FlemonsSpineModelMixed.h
 ...
 */
class FlemonsSpineModelMixed : public BaseSpineModelLearning
{
public: 

    FlemonsSpineModelMixed(int segments);

    virtual ~FlemonsSpineModelMixed();
...
#endif // FLEMONS_SPINE_MODEL_MIXED_H
