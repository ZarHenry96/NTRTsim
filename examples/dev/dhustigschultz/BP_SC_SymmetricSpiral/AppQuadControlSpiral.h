...
#ifndef APP_QUAD_CONTROL_SPIRAL_H
#define APP_QUAD_CONTROL_SPIRAL_H
...
//robot
#include "dev/dhustigschultz/BigPuppy_SymmetricSpiral1/BigPuppySymmetricSpiral1.h"
...
class AppQuadControlSpiral
{
public:
    AppQuadControlSpiral(int argc, char** argv);
...
#endif  // APP_QUAD_CONTROL_SPIRAL_H
