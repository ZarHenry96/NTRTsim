...
#ifndef APP_ACHILLES_HIERARCHY_H
#define APP_ACHILLES_HIERARCHY_H

/**
 * @file AppQuadControlHierarchy.h
...
class AppAchillesHierarchy
{
public:
    AppAchillesHierarchy(int argc, char** argv);
...
private:
    ...
    JSONAchillesHierarchyControl * myControl;
