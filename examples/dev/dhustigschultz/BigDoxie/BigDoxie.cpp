 ...
 */
 ...
 /**
 * @file BigDoxie.cpp
 * @brief Implementing a quadruped based off the Flemons BigPuppy model, now with more segments.
...
void BigDoxie::addNodesFoot(tgStructure& s, double r1, double r2){
    s.addNode(r2,0,r2);//0 
    s.addNode(r2,0,-r2);//1
    s.addNode(-r2,0,-r2);//2 
    s.addNode(-r2,0,r2);//3 
...
void BigDoxie::addRodsFoot(tgStructure& s){
    s.addPair(0,6,"rod");
    s.addPair(1,7,"rod");
    s.addPair(2,4,"rod");
    s.addPair(3,5,"rod");
...
void BigDoxie::addNodesLeg(tgStructure& s, double r){ 
...
void BigDoxie::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void BigDoxie::addNodesHip(tgStructure& s, double r){
...
void BigDoxie::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void BigDoxie::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void BigDoxie::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void BigDoxie::addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, tgStructure& foot, 
                 double r){ 
...
void BigDoxie::addMuscles(tgStructure& puppy){ 
    ...
    puppy.addPair(n13[4], n9[3], tgString("right outer bicep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n13[4], n9[2], tgString("right inner bicep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n13[4], n1[4], tgString("right front abdomen connection muscle seg", 10) + tgString(" seg", 1));

    puppy.addPair(n13[3], n9[3], tgString("right outer tricep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n13[3], n9[2], tgString("right inner tricep muscle seg", 10) + tgString(" seg", 6));

    puppy.addPair(n13[2], n9[3], tgString("right outer front tricep muscle seg", 10) + tgString(" seg", 6));
    puppy.addPair(n13[2], n9[2], tgString("right inner front tricep muscle seg", 10) + tgString(" seg", 6));

    //Adding muscle to pull up on right front leg:
    puppy.addPair(n13[4], n9[1], tgString("right mid bicep muscle3 seg", 10) + tgString(" seg", 6));
    
    //Right front leg/shoulder
    puppy.addPair(n15[4], n11[2], tgString("left inner bicep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n15[4], n11[3], tgString("left outer bicep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n15[4], n1[3], tgString("left front abdomen connection muscle seg", 12) + tgString(" seg", 1)); //Was n1[2]

    puppy.addPair(n15[3], n11[2], tgString("left inner tricep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n15[3], n11[3], tgString("left outer tricep muscle seg", 12) + tgString(" seg", 8));

    puppy.addPair(n15[2], n11[2], tgString("left inner front tricep muscle seg", 12) + tgString(" seg", 8));
    puppy.addPair(n15[2], n11[3], tgString("left outer front tricep muscle seg", 12) + tgString(" seg", 8));
    ...
    //Left rear leg/hip
    puppy.addPair(n14[4], n10[3], tgString("right outer thigh muscle seg", 11) + tgString(" seg", 7)); 
    puppy.addPair(n14[4], n10[2], tgString("right inner thigh muscle seg", 11) + tgString(" seg", 7));

    puppy.addPair(n14[4], n5[1],tgString("right rear abdomen connection muscle seg", 11) + tgString(" seg", 3)); 
    puppy.addPair(n14[3], n7[1],tgString("right rear abdomen connection muscle seg", 11) + tgString(" seg", 5)); 

    puppy.addPair(n14[3], n10[3], tgString("right outer calf muscle seg", 11) + tgString(" seg", 7));
    puppy.addPair(n14[3], n10[2], tgString("right inner calf muscle seg", 11) + tgString(" seg", 7));

    puppy.addPair(n14[2], n10[3], tgString("right outer front calf muscle seg", 11) + tgString(" seg", 7));
    puppy.addPair(n14[2], n10[2], tgString("right inner front calf muscle seg", 11) + tgString(" seg", 7));
    ...
    //Right rear leg/hip
    puppy.addPair(n16[4], n12[2], tgString("left inner thigh muscle seg", 13) + tgString(" seg", 9)); 
    puppy.addPair(n16[4], n12[3], tgString("left outer thigh muscle seg", 13) + tgString(" seg", 9));

    puppy.addPair(n16[4], n5[2], tgString("left rear abdomen connection muscle seg", 13) + tgString(" seg", 3)); 
    puppy.addPair(n16[3], n7[2], tgString("left rear abdomen connection muscle seg", 13) + tgString(" seg", 5)); 

    puppy.addPair(n16[3], n12[2], tgString("left inner calf muscle seg", 13) + tgString(" seg", 9));
    puppy.addPair(n16[3], n12[3], tgString("left outer calf muscle seg", 13) + tgString(" seg", 9));

    puppy.addPair(n16[2], n12[2], tgString("left inner front calf muscle seg", 13) + tgString(" seg", 9));
    puppy.addPair(n16[2], n12[3], tgString("left outer front calf muscle seg", 13) + tgString(" seg", 9));
...
void BigDoxie::setup(tgWorld& world)
{
	...
	tgSpringCableActuator::Config muscleConfigStomach(2*stiffness, damping, passivePretension3);
