...
#ifndef APP_SPINE_CONTROL_STATS_H
#define APP_SPINE_CONTROL_STATS_H

/**
 * @file AppSpineControl.h
...
//robot
#include "dev/dhustigschultz/BigPuppy_SpineOnly_Stats/BigPuppySpineOnlyStats.h"
...
class AppSpineControlStats
{
public:
    AppSpineControlStats(int argc, char** argv);
