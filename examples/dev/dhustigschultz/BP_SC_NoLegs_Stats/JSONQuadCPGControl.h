...
#ifndef JSON_QUAD_CPG_CONTROL_H
#define JSON_QUAD_CPG_CONTROL_H

/**
 * @file JSONCPGControl.h
 * @brief An adaptation of JSONCPGControl that utilizes JSON for parameters
 * @brief Modified for use with quadrupeds, so that certain stats can be gathered. 
 ...
 */
class JSONQuadCPGControl : public tgObserver<BaseQuadModelLearning>, public tgSubject <JSONQuadCPGControl>
{
public:
...
struct Config
    ...
    JSONQuadCPGControl(JSONQuadCPGControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONQuadCPGControl();
...
protected:
    ...
    JSONQuadCPGControl::Config m_config;
