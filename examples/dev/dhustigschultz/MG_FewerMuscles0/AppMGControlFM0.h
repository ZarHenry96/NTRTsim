...
#ifndef APP_MG_CONTROL_FM0_H
#define APP_MG_CONTROL_FM0_H
...
//robot
#include "dev/dhustigschultz/MountainGoatFM0/MountainGoatFM0.h"
...
class AppMGControlFM0
{
public:
   AppMGControlFM0(int argc, char** argv);
...
private:
    ...
    JSONMGFeedbackControlFM0* myControl;
