...
#ifndef APP_QUAD_CONTROL_SEGMENTS_H
#define APP_QUAD_CONTROL_SEGMENTS_H

/**
 * @file AppQuadControl.h
...
//robot
#include "dev/dhustigschultz/BigPuppy_SymmetricSpiral_Segments/BigPuppySymmetricSpiralSegments.h"
...
class AppQuadControlSegments
{
public:
    AppQuadControlSegments(int argc, char** argv);
