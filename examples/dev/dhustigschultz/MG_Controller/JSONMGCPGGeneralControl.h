...
#ifndef JSON_MG_CPG_GENERAL_CONTROL_H
#define JSON_MG_CPG_GENERAL_CONTROL_H

/**
 * @file JSONMGCPGGeneralControl.h
 * @brief An adaptation of JSONCPGControl that utilizes JSON for parameters
 * @brief Modified for use with quadrupeds, so that certain metrics can be gathered. Modified to use 3D multi_array, 
 * since can't override 4D in the original base class. 
...
/**
 * JSONMGCPGGeneralControl learns the parameters for a CPG system on a
 ...
 */
class JSONMGCPGGeneralControl : public tgObserver<BaseQuadModelLearning>, public tgSubject <JSONMGCPGGeneralControl>
{
public:
...
struct Config
    ...
    JSONMGCPGGeneralControl(JSONMGCPGGeneralControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONMGCPGGeneralControl();
...
protected:
    ...
    std::vector<tgCPGMGActuatorControl*> m_allControllers;
    
    JSONMGCPGGeneralControl::Config m_config;
...
#endif // JSON_MG_CPG_GENERAL_CONTROL_H
