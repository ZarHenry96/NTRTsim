...
#ifndef TG_CPG_MG_ACTUATOR_CONTRL_H
#define TG_CPG_MG_ACTUATOR_CONTRL_H

/**
 * @file tgCPGMGActuatorControl.h
...
class tgCPGMGActuatorControl : public tgObserver<tgSpringCableActuator>,
...
public:
    ...
    virtual ~tgCPGMGActuatorControl();
     ...
     */
    void setConnectivity(const std::vector<tgCPGMGActuatorControl*>& allStrings,
             array_3D edgeParams);
