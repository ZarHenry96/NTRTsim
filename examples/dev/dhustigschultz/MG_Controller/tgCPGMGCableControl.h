...
#ifndef TG_CPG_MG_CABLE_CONTROL_H
#define TG_CPG_MG_CABLE_CONTROL_H
...
//Have to modify, because otherwise there are type conversion errors in the tgCPGGeneralActuatorControl class (subclass of tgCPGActuatorControl). 
//Made a new copy so won't totally break Brian's code (and some of my own previous code). 

class tgCPGMGCableControl : public tgCPGMGActuatorControl
{
public:
 
    tgCPGMGCableControl(const tgPIDController::Config pid_config, const double controlStep = 1.0/10000.0);
    
    virtual ~tgCPGMGCableControl();
