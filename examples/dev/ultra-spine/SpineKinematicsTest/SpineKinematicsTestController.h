...
#ifndef SPINE_KINEMATICS_TEST_CONTROLLER_H
#define SPINE_KINEMATICS_TEST_CONTROLLER_H

/**
 * @file SpineKinematicsTestController.h
 * @brief Contains the definition of class SpineKinematicsTestController.
 ...
 */
class SpineKinematicsTestController : public tgObserver<TensegrityModel>, public tgSubject<SpineKinematicsTestController>
{
public:
   ...
   */
  SpineKinematicsTestController(double startTime, double minLength, double rate,
...
#endif // SPINE_KINEMATICS_TEST_CONTROLLER_H
