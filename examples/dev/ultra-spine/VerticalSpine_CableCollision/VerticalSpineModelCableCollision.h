...
#ifndef VERTICAL_SPINE_MODEL_CABLE_COLLISION_H
#define VERTICAL_SPINE_MODEL_CABLE_COLLISION_H

/**
 * @file VerticalSpineModelCableCollision.h
...
class VerticalSpineModelCableCollision: public BaseSpineModelLearning
{
public:

  VerticalSpineModelCableCollision(size_t segments);
  virtual ~VerticalSpineModelCableCollision();
...
/* 	/\** */
/* 	 * A std::vector containing all of the (tgBasicActuators:NOT ANYMORE) amongst */
