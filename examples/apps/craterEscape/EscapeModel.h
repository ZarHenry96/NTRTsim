...
#ifndef ESCAPE_MODEL_H
#define ESCAPE_MODEL_H

/**
 * @file EscapeModel.h
 * @brief Contains the definition of class EscapeModel.
 * $Id$
 */
 ...
 */
class EscapeModel : public tgSubject<EscapeModel>, public tgModel
{
public: 
